...
public class SignInActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		finish = (Button)findViewById(R.id.Button_finishSignIn);
		...
		protected String doInBackground(String... params) {
			try {
			    ...
			    {				    	    				  			    
                    ...
                    buffer.append("birthday").append("=").append(birthday).append("&");
		...
		protected String doInBackground(String... params) {	    		    	
			 try {
			    ...
			    if(http!=null)
			    {
                    ...
                    if(temp2.equals("1"))
                    {
                    	Toast toast = Toast.makeText(context , "이미 ID가 존재합니다.", Toast.LENGTH_SHORT); 
                    	toast.show(); 
                    	Log.e("tag","이미 ID가 존재합니다."); //toast 이미 ID가 존재합니다.                    	                                        
                    } else                    
                    {      
                    	Toast toast = Toast.makeText(context , "사용 할 수 있는 ID입니다.", Toast.LENGTH_SHORT);
